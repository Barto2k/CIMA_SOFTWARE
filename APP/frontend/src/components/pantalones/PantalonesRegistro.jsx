...
export default function PantalonesRegistro({
  AccionABMC,
  Pantalon,
  Grabar,
  Volver,
            ...
            <div className="col-sm-8 col-md-6">
              <input
                ...
                {...register("Marca", {
                  ...
                  minLength: {
                    value: 0,
                    message: "Marca debe tener al menos 0 caracteres",
                  },
                  maxLength: {
                    value: 20,
            ...
            <div className="col-sm-8 col-md-6">
              <input
                ...
                {...register("Modelo", {
                  ...
                  minLength: {
                    value: 0,
                    message: "Modelo debe tener al menos 0 caracteres",
                  },
                  maxLength: {
                    value: 60,
